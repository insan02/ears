<x-layout>
    ...
    <div class="bg-gradient-to-br from-[#e92027] via-[#b91c1c] to-[#7f090b] px-4 md:px-8 pt-8 md:pt-12 pb-24 md:pb-32 rounded-b-[2rem] md:rounded-b-[3rem] shadow-xl mb-8 -mt-4 md:-mt-6 -mx-4 md:-mx-6 relative overflow-hidden">
        <div class="relative z-10 max-w-4xl mx-auto text-center md:text-left">
            <h1 class="text-2xl md:text-4xl font-extrabold text-white tracking-wide">Tambah Pengguna Baru</h1>
            <p class="text-red-100 text-sm md:text-base mt-2 opacity-90 font-light">Isi formulir untuk mendaftarkan akun pengguna baru.</p>
        </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 -mt-16 md:-mt-24 relative z-20 mb-12">
        ...
        <form action="{{ route('management-akun.store') }}" method="POST" class="bg-white rounded-2xl md:rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            @csrf
            <div class="p-6 md:p-8 space-y-6 md:space-y-8">
                <div>
                    <h2 class="text-base md:text-lg font-bold text-[#e92027] border-b border-gray-100 pb-3 mb-6 flex items-center gap-3">
                        <i class="fas fa-user-plus text-[#e92027]"></i> Data Informasi Akun
                    </h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama" value="{{ old('nama') }}" maxlength="50" required
                                class="w-full border border-gray-200 rounded-xl px-4 py-3 bg-gray-50 text-gray-800 focus:bg-white outline-none focus:border-[#e92027] focus:ring-2 focus:ring-[#e92027]/20 transition duration-200 placeholder-gray-400"
